...
def create_llm_engine(model_string: str, use_cache: bool = False, is_multimodal: bool = True, use_nyu_hipaa: bool = False, **kwargs) -> Any:
    """
    Factory function to create appropriate LLM engine instance.
    """
    if any(x in model_string for x in ["gpt", "o1", "o3", "o4"]) or use_nyu_hipaa:
        from .openai import ChatOpenAI
        return ChatOpenAI(model_string=model_string, use_cache=use_cache, is_multimodal=is_multimodal, use_nyu_hipaa=use_nyu_hipaa, **kwargs)
