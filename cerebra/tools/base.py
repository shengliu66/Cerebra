# cerebra/tools/base.py

from cerebra.engine.openai import ChatOpenAI
...
class BaseTool:
    ...
    def __init__(self, tool_name=None, tool_description=None, tool_version=None, input_types=None, output_type=None, demo_commands=None, output_dir=None, user_metadata=None, model_string=None, evaluation_criteria=None):
        """
        ...
        Parameters:
            ...
            evaluation_criteria (dict): Evaluation criteria for the tool (optional).
        """
    ...
    def set_metadata(self, tool_name, tool_description, tool_version, input_types, output_type, demo_commands, user_metadata=None, evaluation_criteria=None):
        """
    ...
    def get_metadata(self):
        ...
        if self.evaluation_criteria:
            metadata["evaluation_criteria"] = self.evaluation_criteria
        return metadata
    ...
    def set_llm_engine(self, model_string, use_nyu_hipaa=False, is_multimodal=False):
        """
        ...
        self.llm_engine_mm = create_llm_engine(model_string=model_string, is_multimodal=is_multimodal, use_nyu_hipaa=use_nyu_hipaa)
        self.llm_engine = create_llm_engine(model_string=model_string, use_nyu_hipaa=use_nyu_hipaa)
